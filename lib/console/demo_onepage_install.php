...
class rex_command_demo_onepage_install extends rex_console_command {
    protected function configure()
    {
        $this->setDescription('Installs the REDAXO onepage demo')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $io->title('Onepage Demo Installation');
        ...
        $errors = rex_demo_onepage::install();
